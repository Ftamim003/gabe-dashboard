...
export default function AdminInformation() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<AdminInfoForm>({
    defaultValues: {
      fullName: "",
      email: "",
      phone: "",
  ...
  useEffect(() => {
    if (fetchedAdminInfo?.data) {
      reset({
        fullName: fetchedAdminInfo.data.fullName || "",
        email: fetchedAdminInfo.data.email || "",
        phone: fetchedAdminInfo.data.phone || "",
         profile: undefined, 
      });
      setPreview(fetchedAdminInfo.data.profilePic || null);
    }
  ...
  const onSubmitAdmin = async (data: AdminInfoForm) => {
    try {
      ...
      if (updateImage) {
      formData.append("file", updateImage as Blob); // must be a File
    }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">Admin Information</h1>
    ...
    <div className="relative">
      {preview ? (
        ...
        <div className="w-40 h-40 rounded-full bg-gray-200 flex items-center justify-center">
          <span className="text-4xl font-bold text-gray-600">
            {fetchedAdminInfo?.data.fullName?.[0] || "A"}
          </span>
        </div>
      )}
      <label
      ...
      />
            ...
            <div className="flex justify-end space-x-4">
              ...
              <Button type="submit" className="bg-blue-600 text-white hover:bg-blue-700 cursor-pointer" disabled={isUpdating}>
