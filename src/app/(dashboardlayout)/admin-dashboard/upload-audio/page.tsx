...
import { useUploadAudioMutation } from "@/redux/features/audio/audioSlice";
...
export default function UploadAudioPage() {
  ...
  const onSubmit = async (data: UploadFormValues) => {
    ...
    try {
      ...
      toast.success("Workout audio uploaded successfully!");
      reset();
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mx-auto">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-md p-8 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Maximum Size Of The file Can Be 50 Mb
          </p>
          ...
          {errors.audio && (
            <p className="mt-2 text-sm text-red-600">Audio file is required</p>
          )}
        </div>
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            {isLoading ? "Uploading..." : "Upload This New Workout Audio"}
          </button>
        </div>
      </form>
    </div>
