...
export default function SubscriptionPlanPage() {
  ...
  const { register, handleSubmit, reset, watch } = useForm<PlanFormData>({
    defaultValues: {
      ...
      facility01:
        activeTab === "free" ? "AI generated workout" : "Advanced AI workouts",
      facility02:
        activeTab === "free"
          ? "Full access to the phase 1"
    ...
    reset({
      ...
      supportingText:
        tab === "free"
          ...
          : "Unlock premium features",
      facility01:
        tab === "free" ? "AI generated workout" : "Advanced AI workouts",
      facility02:
        tab === "free"
          ? "Full access to the phase 1"
          : "Full access to all phases",
